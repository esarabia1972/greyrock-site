      ...
      <nav className="fixed top-0 w-full bg-white/90 backdrop-blur-sm border-b border-slate-200 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Button variant="primary" onClick={() => { const element = document.getElementById('convocatorias'); if (element) { const offset = element.offsetTop - 100; window.scrollTo({ top: offset, behavior: 'smooth' }); } }}>Postulá tu idea</Button>
          </div>
        </div>
      </nav>
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center mb-8">
            <div className="bg-red-900 text-red-100 px-6 py-3 rounded-lg flex items-center gap-2">
              ...
              <span className="font-semibold">Inscripción cierra: 30 de Noviembre 2025</span>
            </div>
